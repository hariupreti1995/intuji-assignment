<div class="bg-indigo-900 text-white w-64 space-y-6 py-7 px-2">
    <div class="flex items-center space-x-2 px-4 border-b-2 mb-14 pb-4 border-slate-900">
        ...
        <div>
            <h2 class="text-lg uppercase font-semibold bg-clip-text text-transparent bg-gradient-to-b from-white to-red-500">Eventer</h2>
    ...
    <nav class="mt-10 ">
        ...
        <a href="#" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-indigo-800 bg-slate-800">All
            Event</a>
    </nav>
</div>